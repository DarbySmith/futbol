...
RSpec.describe Season do
  ...
  describe 'it handles the Season methods' do
    ...
    it '#team_tackles_calculation' do
      team_total_tackles = {
        "20"=>18, 
        "28"=>14,
        "30"=>22,
      ...
      expect(@season.team_tackles_calculation("20132014")).to eq(team_total_tackles)
    end

    it '#team_name_from_id_average' do
    # will be renamed and placed in module
      expect(@season.team_name_from_id_average(["16", 3.333])).to eq("New England Revolution")
    end
